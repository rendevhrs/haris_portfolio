...
const Footer = () => {
  return (
    <div id="works" className=" mx-auto m-auto h-[300px]  mt-16 sm:h-[250px]">
      <div className=" bg-violet-400 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        <h2 
        data-aos="zoom-out"
        ...
        <div className=" flex items-center justify-center gap-8 sm:gap-5">
          ...
          data-aos="fade-up" data-aos-duration="1000"
            ...
            href="https://www.linkedin.com/in/harisnf300"
        ...
        <div className="sm:text-[12px]">
          | Copyright &copy; <span>2023 HarisNF </span> All rights reserved
          <a href="#"></a> |
        </div>
      </div>
    </div>
